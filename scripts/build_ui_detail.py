...
"""Холст точечной правки: выделил область → поправил → получил полный кадр.
  ...
  py -3 build_ui_detail.py [--out <файл>] [--verify] [--image <имя на воркере>]

НА ВЫХОДЕ — ФАЙЛ ДЛЯ ComfyUI. Открывается через Load или перетаскиванием,
кладётся в templates/comfy/PERSONA_DETAIL_EDIT.json.
